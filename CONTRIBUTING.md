# Contributing to `coolms/entity-doctrine`
...
`coolms/entity-doctrine` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/entity-doctrine 2.0.0` does not assert that this package broke something; it
